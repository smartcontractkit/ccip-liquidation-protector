...
import {IMockLending} from "../interfaces/IMockLending.sol";
 ...
 */
contract MonitorMockLending is
    ...
    Withdraw
{
    ...
    constructor(
        ...
        router = _router;
        i_link = _link;
        i_lendingAddress = _lendingAddress;
        i_tokenAddress = _tokenAddress;
        i_onBehalfOf = _onBehalfOf;
        i_lpsc = _lpsc;
    ...
    function _ccipReceive(
        ...
        IMockLending(i_lendingAddress).deposit(
            i_tokenAddress,
            amountToRepay,
            i_onBehalfOf
        );
