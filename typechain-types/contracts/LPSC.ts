...
export interface LPSCInterface extends utils.Interface {
  functions: {
    "acceptOwnership()": FunctionFragment;
    "ccipReceive((bytes32,uint64,bytes,bytes,(address,uint256)[]))": FunctionFragment;
    "getRouter()": FunctionFragment;
    "owner()": FunctionFragment;
    "reply(address,uint256,uint64,address,bytes32)": FunctionFragment;
  ...
  events: {
    ...
    "ReplySent(bytes32,uint64,bytes32,address,address,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferRequested"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ReplySent"): EventFragment;
}
...
export interface ReplySentEventObject {
...
export type ReplySentEvent = TypedEvent<
  [string, BigNumber, string, string, string, BigNumber],
  ReplySentEventObject
>;

export type ReplySentEventFilter = TypedEventFilter<ReplySentEvent>;

export interface LPSC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LPSCInterface;
  ...
  filters: {
    ...
    "ReplySent(bytes32,uint64,bytes32,address,address,uint256)"(
      replyMessageId?: null,
