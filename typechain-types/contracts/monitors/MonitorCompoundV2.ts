...
export interface MonitorCompoundV2Interface extends utils.Interface {
  functions: {
...
export interface MonitorCompoundV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MonitorCompoundV2Interface;
