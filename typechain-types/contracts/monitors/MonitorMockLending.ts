...
export interface MonitorMockLendingInterface extends utils.Interface {
  functions: {
...
export interface MonitorMockLending extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MonitorMockLendingInterface;
