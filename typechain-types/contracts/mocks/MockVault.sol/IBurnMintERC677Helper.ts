...
export interface IBurnMintERC677HelperInterface extends utils.Interface {
  functions: {
...
export interface IBurnMintERC677Helper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBurnMintERC677HelperInterface;
